...
add_gmsh_contact(mesh=mesh, gmsh_name="First_contact",  region="air", material="metal", name="First_contact")
add_gmsh_contact(mesh=mesh, gmsh_name="Second_contact", region="air", material="metal", name="Second_contact")
add_gmsh_contact(mesh=mesh, gmsh_name="Third_contact",  region="air", material="metal", name="Third_contact")
add_gmsh_contact(mesh=mesh, gmsh_name="Fourth_contact", region="air", material="metal", name="Fourth_contact")
add_gmsh_contact(mesh=mesh, gmsh_name="Fifth_contact", region="air", material="metal", name="Fifth_contact")
...
contacts = ["world_boundary_contact", "First_contact", "Second_contact", "Third_contact", "Fourth_contact", "Fifth_contact"]
...
# ----------------------------
phi_first_contact = solve_basis("First_contact", contacts)
phi_third_contact = solve_basis("Third_contact", contacts)
phi_fifth_contact = solve_basis("Fifth_contact", contacts)
...
np.savez(
    ...
    phi_first_contact=phi_first_contact,
    phi_third_contact=phi_third_contact,
    phi_fifth_contact=phi_fifth_contact,

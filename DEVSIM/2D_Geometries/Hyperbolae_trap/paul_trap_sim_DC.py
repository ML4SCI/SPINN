...
create_gmsh_mesh(file="paul_trap_hyperbola_mesh.msh", mesh=mesh)
...
contacts = ["world_boundary_contact", "North_contact", "South_contact", "East_contact", "West_contact"]
...
# ----------------------------
phi_north_contact = solve_basis("North_contact", contacts)
phi_south_contact = solve_basis("South_contact", contacts)
...
np.savez(
    ...
    phi_north_contact=phi_north_contact,
    phi_south_contact=phi_south_contact,

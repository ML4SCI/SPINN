...
create_gmsh_mesh(file="paul_trap_surface_electrode_mesh.msh", mesh=mesh)

ELECTRODES = ["DC_Center", "RF_North", "RF_South", "DC_North", "DC_South"]
...
DC_contacts = ["world_boundary_contact",
               "DC_Center_contact", "DC_North_contact", "DC_South_contact"]
RF_contacts = ["RF_North_contact", "RF_South_contact"]

DC_voltage = 0.0
RF_voltage = 150.0   # peak RF amplitude [V] — surface traps use lower drive than macro traps
...
# Proper 3D DEVSIM recipe (see devsim/devsim_3dmos): project edge-based
# ElectricField onto element-based ElectricField_x/y/z.

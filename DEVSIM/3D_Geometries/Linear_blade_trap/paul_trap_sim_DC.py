...
# ----------------------------
# Electrostatic PDE (dimension-agnostic; same edge-based discretization as 2D)
# ----------------------------
eps0 = 8.854e-14   # F/cm
...
# ----------------------------
# Compute base functions only for DC electrodes (DC blades + endcaps + world).
# RF blades are excluded — their role is handled by paul_trap_sim_RF.py.
# ----------------------------
dc_active = [
    "DC_North_contact", "DC_South_contact",

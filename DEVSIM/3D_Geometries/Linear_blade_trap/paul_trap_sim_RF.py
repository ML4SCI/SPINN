...
create_gmsh_mesh(file="paul_trap_linear_blade_mesh.msh", mesh=mesh)

ELECTRODES = ["RF_East", "RF_West", "DC_North", "DC_South", "Endcap_Top", "Endcap_Bot"]
...
DC_contacts = ["world_boundary_contact", "DC_North_contact", "DC_South_contact",
               "Endcap_Top_contact", "Endcap_Bot_contact"]
RF_contacts = ["RF_East_contact", "RF_West_contact"]
...
# Project the edge-based ElectricField onto element-based ElectricField_x/y/z.
# This is the proper DEVSIM 3D recipe (see devsim/devsim_3dmos: mos_physics.py).
# `vector_gradient` produces garbage on 3D tet meshes — element_from_edge_model
# is the supported path for getting per-cell field components.

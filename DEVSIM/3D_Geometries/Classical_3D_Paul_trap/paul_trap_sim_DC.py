...
create_gmsh_mesh(file="paul_trap_classical_3D_mesh.msh", mesh=mesh)
...
# DC base functions for the endcaps + world. Ring is excluded — it is the RF
# electrode and is handled by paul_trap_sim_RF.py.
dc_active = ["Endcap_Top_contact", "Endcap_Bot_contact", "world_boundary_contact"]

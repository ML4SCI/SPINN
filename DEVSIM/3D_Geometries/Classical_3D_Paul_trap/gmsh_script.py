...
gmsh.initialize()
gmsh.model.add("paul_trap_classical_3D")

# =========================================================
# Parameters (cm) — classical Wolfgang Paul geometry.
# Saddle-point radius r0; axial half-spacing z0 = r0/sqrt(2)
# gives the ideal hyperbolic Paul trap (r0^2 = 2 z0^2).
#
# Ring electrode is a hyperboloid of ONE sheet:  r^2/r0^2 - z^2/z0^2 = 1
# Endcap electrodes are hyperboloids of TWO sheets: z^2/z0^2 - r^2/r0^2 = 1
# Both are constructed by revolving an (r,z) profile around the z-axis.
# =========================================================
r0 = 0.10                       # saddle radius
z0 = r0 / math.sqrt(2.0)        # ideal axial spacing
...
gmsh.write("paul_trap_classical_3D_mesh.msh")
